...
\begin{table}[htbp]
    ...
    \begin{tabular}{l ccc}
        \hline
        Condition                 & depth (pp)             & area                   & ACC                        \\
        \hline
        \multicolumn{4}{l}{\emph{Momentum $0.0$}}                                                                 \\
        Vanilla ER                & $19.5 \pm 4.1$         & $6.3 \pm 0.5$          & $0.873 \pm 0.005$          \\
        C3: $N{=}200$             & $14.3 \pm 4.6$         & $1.8 \pm 0.6$          & $0.828 \pm 0.025$          \\
        C4: adaptive              & $12.8 \pm 2.9$         & $2.2 \pm 0.5$          & $0.833 \pm 0.025$          \\
        C7: $\lambda_{\min}{=}0.20$ & $13.9 \pm 3.4$       & $2.7 \pm 0.6$          & $0.837 \pm 0.031$          \\
        \hline
        \multicolumn{4}{l}{\emph{Momentum $0.9$}}                                                                 \\
        Vanilla ER                & $15.9 \pm 2.6$         & $1.0 \pm 0.2$          & $0.928 \pm 0.003$          \\
        C3: $N{=}200$             & $6.2 \pm 0.6$          & $0.1 \pm 0.0$          & $0.925 \pm 0.007$          \\
        C4: adaptive              & $2.5 \pm 0.5$          & $0.3 \pm 0.1$          & $0.917 \pm 0.001$          \\
        C7: $\lambda_{\min}{=}0.20$ & $\mathbf{3.7 \pm 0.4}$ & $\mathbf{0.0 \pm 0.0}$ & $\mathbf{0.931 \pm 0.002}$ \\
        \hline
    \end{tabular}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l cccc}
        \hline
        $\delta$ & depth (pp)             & area            & ACC     & $\mathrm{WP}_{100}$ \\
        \hline
        \multicolumn{5}{l}{\emph{Momentum $0.0$}}                                            \\
        no gate  & $19.5 \pm 4.1$         & $6.27$          & $0.873$ & $0.736$             \\
        $1.0$    & $9.0 \pm 0.6$          & $3.29$          & $0.869$ & $0.733$             \\
        $0.3$    & $7.4 \pm 1.1$          & $2.32$          & $0.873$ & $0.736$             \\
        $0.1$    & $5.9 \pm 1.5$          & $1.56$          & $0.876$ & $0.739$             \\
        $0.03$   & $\mathbf{4.8 \pm 1.9}$ & $\mathbf{1.04}$ & $0.880$ & $0.741$             \\
        \hline
        \multicolumn{5}{l}{\emph{Momentum $0.9$}}                                            \\
        no gate  & $15.9 \pm 2.6$         & $1.03$          & $0.928$ & $0.808$             \\
        $0.3$    & $10.4 \pm 0.5$         & $0.50$          & $0.929$ & $0.813$             \\
        $0.1$    & $9.4 \pm 0.5$          & $0.38$          & $0.928$ & $0.815$             \\
        $0.03$   & $8.5 \pm 0.6$          & $0.23$          & $0.929$ & $0.816$             \\
        \hline
    \end{tabular}
...
The protection does not survive the accelerator. Repeating the same standard-buffer sweep at momentum $0.9$ (the solid lines of Figure~\ref{fig:per_curves}, rung by rung in Figure~\ref{fig:per_sweep}(c)) moves every rung the wrong way: depth climbs from $7.4$, $5.9$ and $4.8$ pp at $\delta = 0.3$, $0.1$ and $0.03$ to $10.4$, $9.4$ and $8.5$ pp, the whole ladder displaced upward by $3$ to $4$ pp with its ordering intact, so no setting of the filter recovers the momentum-$0$ protection (Table~\ref{tab:res_per}). The mechanism is the per-step locality of the gate. It brakes the push once, at the step it is applied, but momentum accumulates the braked updates and rebuilds the very displacement the filter removed, so what the gate subtracts at one step returns over the next several. Against vanilla ER at the same momentum ($15.9$ pp) the gate still helps, but the reduction it buys falls from ${\approx}75\%$ of vanilla's depth at momentum $0$ to ${\approx}47\%$, and it buys nothing in accuracy that vanilla does not already have ($0.929$ against $0.928$). The area moves the other way, $1.04 \rightarrow 0.23$ at $\delta = 0.03$, as it does for vanilla ER itself ($6.3 \rightarrow 1.0$): momentum shortens every transient, so depth rather than area is the axis on which the loss of protection is visible. This is the failure the scalar gate does not share, and it is what Section~\ref{subsec:res_regimeflip} reads as a regime flip rather than a trade-off.
