...
\begin{description}
    ...
    \item[RQ6 (generalisation).] Do the rot-MNIST findings carry over to a deeper backbone (ResNet-18) and a stronger task shift (CIFAR-10 domain corruption)? Specifically, does the adaptive curriculum still reduce gap depth relative to vanilla ER, and at least match NCL, while preserving final accuracy --- under both BatchNorm and GroupNorm and on corruptions it was not tuned on? The qualitative carry-over is the prediction; the $O(1/N)$ scaling of the bound is not expected to hold tightly at this depth.
\end{description}
