...
This appendix gives the full metric set for every condition of the main
experimental blocks, as recorded by the aggregation pipeline of
Section~\ref{subsec:metrics}. Each row is the mean over
...
reaches $0.955$, the highest of any gate condition, while re-introducing only a $2.0$
...
\begin{table}[H]
    ...
    \caption{rot-MNIST asymmetric-PER $\delta$ sweep, full metrics: both buffer
        ...
        (${\approx}0.965$) are the diagnostic values referenced in the main text.}
...
\begin{table}[H]
    ...
    \begin{tabular}{l ccc c cc}
        ...
        3-task --- curric.      & 0.745\,$\pm$\,0.010 & -0.021\,$\pm$\,0.008 & 0.677\,$\pm$\,0.025 & 0.696\,$\pm$\,0.017 & 6.9\,$\pm$\,2.7   & 4.1\,$\pm$\,1.1   \\
        \hline
        ...
        3-task --- curric.      & 0.721\,$\pm$\,0.019 & -0.025\,$\pm$\,0.020 & 0.421\,$\pm$\,0.114 & 0.517\,$\pm$\,0.070 & 32.8\,$\pm$\,14.5 & 16.9\,$\pm$\,10.2 \\
        \hline
    \end{tabular}
...
wall clock and mask the solve; the overhead is far larger on the deeper backbone.
...
\begin{table}[H]
    ...
    \caption{Wall-clock of the gate-active task ($T_1$), mean over five seeds. The scalar
        ...
        multiple is far larger than on the MLP. The MLP vanilla cell is omitted because its
