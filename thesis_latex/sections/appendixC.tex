...
This subsection collects supplementary per-step curves: the five-task
rot-MNIST sequence (the multi-transition check reported in Table~\ref{tab:app_longseq})
