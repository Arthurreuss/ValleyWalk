...
$\delta$ sweep on both buffer legs and at both momentum settings; the standard-buffer momentum-$0$
...
Figure~\ref{fig:per_sweep} is the trajectory form of Table~\ref{tab:res_per}:
