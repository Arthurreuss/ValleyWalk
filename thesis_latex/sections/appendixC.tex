...
This subsection collects supplementary figures: the accuracy--depth scatter of
...
\begin{figure*}[htbp]
    ...
    \caption{Accuracy--depth scatter of every rot-MNIST gate condition: final accuracy
        ...
        method. This figure is retained as the underlying scatter; the frontier reading it once
        suggested is superseded.}
    \label{fig:frontier}
\end{figure*}
