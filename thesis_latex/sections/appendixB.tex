...
\begin{table}[H]
    ...
    \begin{tabular}{@{}p{2.5cm} p{7.7cm} p{4.4cm}@{}}
        ...
        \texttt{gap\_area\_w250} & \texttt{gap\_area} restricted to the first $250$ steps after the transition                                                                                                                                                                                                                                                                       & Windowed pre-referenced area; isolates the transient from later drift. Back-comparability                                                                                    \\
