...
\begin{table}[H]
    ...
    \begin{tabular}{@{}p{4.2cm} p{3.0cm} p{7.2cm}@{}}
        ...
        \hline
        $\cos(g_{\text{replay}}, g_{\text{true}})$    & \texttt{true\_grad\_cosine}     & Buffer-side directional fidelity, the estimator-variance contributor of Section~\ref{subsec:decomposition} \\
