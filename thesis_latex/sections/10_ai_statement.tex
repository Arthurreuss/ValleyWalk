...
contributors. Specifically, I used them to:

\begin{itemize}
    \setlength{\itemsep}{0pt}
    \item brainstorm and stress-test ideas, and as a sounding board to reason
          through arguments and explanations;
    \item draft and revise prose, which I subsequently edited for accuracy,
          precision, and voice;
    \item assist in writing and refactoring the analysis and experiment code,
          all of which I reviewed, ran, and tested;
    \item produce first-pass summaries of the literature, which I verified
