...
\begin{figure*}[t]
    \centering
    \begin{minipage}[t]{0.105\textwidth}\centering
    ...
    \end{minipage}\hfill
    \begin{minipage}[t]{0.105\textwidth}\centering
        \includegraphics[width=\linewidth]{img/joint_loss_lambda_evolution/joint_loss_lambda_0_499.png}\\
        {\scriptsize $0.499$}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.105\textwidth}\centering
        \includegraphics[width=\linewidth]{img/joint_loss_lambda_evolution/joint_loss_lambda_0_749.png}\\
        {\scriptsize $0.749$}
    \end{minipage}\hfill
    \begin{minipage}[t]{0.105\textwidth}\centering
