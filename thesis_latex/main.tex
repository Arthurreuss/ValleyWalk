...
% Same allowance for single-column floats: the tall results figures run to ~90%
% of a column, above the 0.7 default, which would otherwise push them a page on.
...
\begin{appendices}
    ...
    \input{sections/appendixD.tex} % Derivation of the Trajectory Bound
    % \newpage
